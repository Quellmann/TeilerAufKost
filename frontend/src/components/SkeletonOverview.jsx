  ...
  return (
    <div className="rounded-lg border border-light-border dark:border-dark-border">
      ...
      <div className="flex items-center justify-between border-b border-light-border dark:border-dark-border">
        <div className="skeleton h-14 w-full rounded-t-lg"></div>
      </div>
      {/* Saldo rows */}
      <div className="rounded-lg divide-y divide-light-border dark:divide-dark-border bg-light-card dark:bg-dark-card border border-light-border dark:border-dark-border mx-2 mt-10">
        <MemberRow />
        <MemberRow />
        <MemberRow />
        <MemberRow />
      ...
      <div className="mx-2 mb-2 mt-14 rounded-lg divide-y divide-light-border dark:divide-dark-border border border-light-border dark:border-dark-border bg-light-card dark:bg-dark-card">
        <div className="h-14 flex items-center justify-between">
          <div className="skeleton w-1/3 h-10 mx-2 rounded-lg"></div>
          <div className="skeleton w-20 h-10 mx-2 rounded-lg"></div>
          <div className="skeleton w-10 h-10 mx-2 rounded-lg"></div>
        </div>
        <div className="h-14 flex items-center justify-between">
          <div className="skeleton w-1/3 h-10 mx-2 rounded-lg"></div>
          <div className="skeleton w-20 h-10 mx-2 rounded-lg"></div>
